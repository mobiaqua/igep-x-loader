 ...
 * 165MHz (optimized) 6.06ns
 * ACTIMA
 *	TDAL = 15 / 6.06 + 15 / 6.06 = 2.5 + 2.5 -> 5
 *	TDPL (TWR) = 15 / 6.06 = 2.5 -> 3
 *	TRRD = 10 / 6.06 = 1.65 -> 2
 *	TRCD = 15 / 6.06 = 2.5 -> 3
 *	TRP = 15 / 6.06 = 2.5 -> 3
 *	TRAS = 40 / 6.06 = 6.6 -> 7
 *	TRC = 55 / 6.06 = 9.1 -> 10
 *	TRFC = 72 / 6.06 = 11.9 -> 12
 * ACTIMB
 *	TWTR = 2
 *	TCKE = 2
 *	TXSR = 112.5 / 6.06 = 18.6 = 19
 *	TXP = 2
 */
...
#define MT29CXGXXMAXX_V_ACTIMA_165		\
	((MT29CXGXXMAXX_TRFC_165 << 27) |	\
	 (MT29CXGXXMAXX_TRC_165 << 22) |	\
	 (MT29CXGXXMAXX_TRAS_165 << 18) |	\
	 (MT29CXGXXMAXX_TRP_165 << 15) |	\
	 (MT29CXGXXMAXX_TRCD_165 << 12) |	\
	 (MT29CXGXXMAXX_TRRD_165 << 9) |	\
	 (MT29CXGXXMAXX_TDPL_165 << 6) |	\
	 (MT29CXGXXMAXX_TDAL_165))

#define MT29CXGXXMAXX_TWTR_165	2
#define MT29CXGXXMAXX_TCKE_165	2
#define MT29CXGXXMAXX_TXSR_165	19
#define MT29CXGXXMAXX_TXP_165	2
#define MT29CXGXXMAXX_V_ACTIMB_165		\
	((MT29CXGXXMAXX_TCKE_165 << 12) |	\
	 (MT29CXGXXMAXX_TXSR_165 << 0)) |	\
	(MT29CXGXXMAXX_TXP_165 << 8) |		\
...
# define SMNAND_GPMC_CONFIG2 0x00141400
# define SMNAND_GPMC_CONFIG3 0x00141400
# define SMNAND_GPMC_CONFIG4 0x0D010D01
# define SMNAND_GPMC_CONFIG5 0x010A1414
# define SMNAND_GPMC_CONFIG6 0x1F0F0A80
# define SMNAND_GPMC_CONFIG7 0x00000C44

/* Micron & Hynix memories share this configuration */
#ifdef __notdef
# define M_NAND_GPMC_CONFIG1 0x00001800
# define M_NAND_GPMC_CONFIG2 0x00030700
# define M_NAND_GPMC_CONFIG3 0x00020001
# define M_NAND_GPMC_CONFIG4 0x02000402
# define M_NAND_GPMC_CONFIG5 0x00050707
# define M_NAND_GPMC_CONFIG6 0x00000180
# define M_NAND_GPMC_CONFIG7 0x00000C44
#else

# define M_NAND_GPMC_CONFIG1 0x00001801
// # define M_NAND_GPMC_CONFIG2 0x00080800
// # define M_NAND_GPMC_CONFIG3 0x00080502
// # define M_NAND_GPMC_CONFIG4 0x06020A02
// # define M_NAND_GPMC_CONFIG5 0x000B0F0F
// # define M_NAND_GPMC_CONFIG6 0x06000A80
# define M_NAND_GPMC_CONFIG7 0x00000F70

/* CS Signal timming configuration */
#define CSWROFFTIME         0x7
#define CSRDOFFTIME         0x7     // (100 Mhz = 10 nS) : 80 nS
#define CSEXTRADELAY        0
#define CSONTIME            0x0

#define ADVWROFFTIME        CSWROFFTIME
#define ADVRDOFFTIME        CSRDOFFTIME
#define ADVEXTRADELAY       0
#define ADVONTIME           0x1

#define WEOFFTIME           0x4
#define WEEXTRADELAY        0
#define WEONTIME            0x0
#define OEOFFTIME           0x5
#define OEEXTRADELAY        0
#define OEONTIME            0

#define RDACCESSTIME        OEOFFTIME-1
#define WRCYCLETIME         CSWROFFTIME
#define RDCYCLETIME         CSRDOFFTIME

#define WRACCESSTIME        OEOFFTIME
#define CYCLE2CYCLEDELAY    0
#define CYCLE2CYCLESAMECS   0
#define CYCLE2CYCLEDIFFCS   1
#define BUSTURNAROUND       1

#define M_NAND_GPMC_CONFIG2 ((CSWROFFTIME << 16) | ( CSRDOFFTIME << 8) | (CSEXTRADELAY << 7) | CSONTIME)
#define M_NAND_GPMC_CONFIG3 ((ADVWROFFTIME << 16) | (ADVRDOFFTIME << 8) | (ADVEXTRADELAY << 7) | ADVONTIME)
#define M_NAND_GPMC_CONFIG4 ((WEOFFTIME << 24) | (WEEXTRADELAY << 23) | (WEONTIME << 16) | (OEOFFTIME << 8) | (OEEXTRADELAY << 7) | OEONTIME)
#define M_NAND_GPMC_CONFIG5 ((RDACCESSTIME << 16) | (WRCYCLETIME << 8) | RDCYCLETIME)
#define M_NAND_GPMC_CONFIG6 ((WRACCESSTIME << 24) | (CYCLE2CYCLEDELAY << 8) | (CYCLE2CYCLESAMECS << 7) | (CYCLE2CYCLEDIFFCS << 6) | BUSTURNAROUND)
